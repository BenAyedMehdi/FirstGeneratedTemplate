                ...
                <div className="flex md:flex-col flex-row md:gap-10 gap-[100px] items-start justify-start mx-2.5">
                  ...
                  <div className="flex flex-1 flex-col items-start justify-start w-full">
                    <div className="flex flex-col gap-[30px] items-start justify-start w-full">
                      ...
                      >
                        We invite individuals worldwide to join this movement,
                        whether as volunteers, ambassadors, or contributors.
                        Together, let's shape a brighter future and make a
                        meaningful impact on our planet. 🌍🚀✨.{" "}
                      </Text>
                    </div>
                  </div>
                </div>
