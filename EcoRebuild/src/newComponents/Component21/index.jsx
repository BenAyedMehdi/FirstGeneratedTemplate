        ...
        <div className="flex flex-col gap-4 items-center justify-start w-full">
          ...
          <div className="bg-white-A700 border border-bluegray-100 border-solid flex md:flex-col flex-row gap-[50px] items-start justify-start p-[50px] md:px-10 sm:px-5 rounded-[10px] w-full">
            ...
            <div className="flex flex-1 flex-col gap-10 items-start pl-10 justify-center w-full">
              ...
              <Text className=" md:text-[22px] text-center text-gray-900 sm:text-xl tracking-[-0.48px] w-full"
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        <Input
          ...
          type="text"
          prefix={<Img className="h-5 mr-3" src="images/img_user.svg" alt="user" />}
        ></Input>
        <Input
          name="user_email"
          ...
          wrapClassName="bg-white border border-gray-200 rounded-lg p-4"
          type="email"
          prefix={<Img className="h-5 mr-3" src="images/img_mail_gray_600_24x24.svg" alt="mail" />}
        ></Input>
        <Input
          ...
          wrapClassName="bg-white border border-gray-200 rounded-lg p-4"
          type="number"
          prefix={<Img className="h-5 mr-3" src="images/img_call.svg" alt="call" />}
        ></Input>
        <Input
          name="message"
          className="font-semibold placeholder:text-gray-600 text-gray-600 text-lg w-full"
