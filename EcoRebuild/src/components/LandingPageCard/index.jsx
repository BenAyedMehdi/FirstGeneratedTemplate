      ...
      <div className="bg-gray-51 border border-red-101 border-solid flex flex-col items-start justify-start px-5 py-[20px] rounded-[10px] w-full">
        ...
        <div className="flex flex-col items-start justify-start w-full">
          <div className="flex flex-row gap-3 py-[20px] items-center justify-start w-full">
            <Text className="flex-1 text-lg text-gray-900 w-auto h-[50px]" size="txtManropeSemiBold16">
              {project?.name}
            </Text>
          </div>
          <div className="flex flex-row gap-[31px] items-center justify-center w-full">
            <Button onClick={projectChoice} className="bg-gray-900 cursor-pointer flex-1 font-manrope font-semibold py-[13px] rounded-[10px] text-base text-center text-white-A700 w-auto">
              <Link to="/projectdetails">View Details</Link>
            </Button>
            <Button className="common-pointer bg-gray-900 cursor-pointer gap-[10px] flex items-center rounded-[10px] py-[13px] justify-center min-w-[124px]" onClick={openYoutubeVideo} rightIcon={<Img src="images/img_play.svg" alt="Video" />}>
